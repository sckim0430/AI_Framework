...
def parse_args():
    ...
    parser.add_argument('--model_config_dir',default='/home/sckim/Program/configs/models/alexnet/alexnet.py',help='model config path')
    parser.add_argument('--train_config_dir',default='/home/sckim/Program/configs/train_config.py',help='train config path')
    parser.add_argument('--validation_config_dir',default='/home/sckim/Program/configs/validation_config.py',help='validation config path')
    parser.add_argument('--resource_config_dir',default='/home/sckim/Program/configs/resource_config.py',help='resource config path')
